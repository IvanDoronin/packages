...
class EmailValueFailure extends ValueFailure<String> {
  ...
  factory EmailValueFailure.invalidFormat({
    required String failedValue,
  }) {
    return EmailValueFailure._(
        failedValue: failedValue,
        message:
            'That doesn\'t seem like a valid email. An email should contain @');
  }

  factory EmailValueFailure.invalidDomain({
    required String failedValue,
  }) {
    return EmailValueFailure._(
        failedValue: failedValue,
  ...
  factory EmailValueFailure.emptyInput({
    required String failedValue,
  }) {
    return EmailValueFailure._(
        failedValue: failedValue, message: 'The email can\'t be blank');
  }

  factory EmailValueFailure.containsSpaces({
    required String failedValue,
  }) {
    return EmailValueFailure._(
        failedValue: failedValue, message: 'The email can\'t have spaces');
  }
